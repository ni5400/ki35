...
<div class="form_con">
    ...
    <div class="alert alert-warning alert-dismissible" role="alert">
        ...
        <strong>提示！</strong> 角色只能修改状态 <br/>
    </div>
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1">
            <legend></legend>
            <h4 class="text-center">修改角色</h4>
            <form id="role_add" method="post" class="form-horizontal" action="<?php echo U('AuthGroup/group_editHandle');?>">
                <fieldset>
                    <legend></legend>
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="title" value="<?php echo ($role['title']); ?>" disabled/>
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="status" value="1" <?php if($role['status']==1): ?>checked<?php endif; ?>>  启用(默认是启用状态)
                                </label>
                            </div>
                        </div>
                    </div>
