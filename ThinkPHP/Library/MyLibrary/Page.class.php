...
class Page{
    ...
    public function show() {
        ...
        $down_page = ($down_row <= $this->totalPages) ? '<li><a class="next" aria-label="Next" href="' . $this->url($down_row) . '"><span aria-hidden="true">' . $this->config['next'] . '</span></a>' : '';
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<div class='my-page'><ul class='pagination' style='margin: 0px;'>{$page_str}</ul></div>";
    }
}
