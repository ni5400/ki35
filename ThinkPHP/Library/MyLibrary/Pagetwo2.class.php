...
class Pagetwo {
    ...
    protected $coolPages ;
    // 分页显示定制
    protected $config =	array('header'=>'条记录','prev'=>' 上一页','next'=>'下一页','first'=>'首页','last'=>'末页','theme'=>' <div class="row pagination"><div class="span2">共%totalRow% %header% %nowPage%/%totalPage% 页</div><div class="span"><div><ul><li>%first%</li><li>%upPage%</li><li>%linkPage%</li><li>%downPage%</li><li>%end%</li></ul></div></div><div class="span2" style="margin-top:-5px;">跳转至第%go%页</div> ');
    // 默认分页变量名
    public $varPage;
    /**
     * 架构函数
